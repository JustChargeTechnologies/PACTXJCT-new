      ...
      <div className=" bg-[#FFF5E999] h-auto w-full flex justify-center items-center   py-10">
        ...
        style={{ backgroundImage: `url(${bg})` }}>
          <div className="flex flex-col px-2 py-1 md:px-15 md:py-10 justify-center items-center">
            ...
            <p className=" text-[16px] md:text-[20px] leading-[26px] nunito-sans text-center mt-6">
            ...
            <h1 className="margarine-regular text-[38px] md:text-[56px] text-white leading-[100%] text-center mt-3">Be a part of the change. Together, let's Empower Tomorrow!</h1>
