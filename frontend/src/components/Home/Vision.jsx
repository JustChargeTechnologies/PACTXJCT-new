      ...
      <div className="bg-[#FFF5E999]  h-auto md:px-22">
        ...
        <div className="left-section max-w-[621px] min-h-[372px] p-5 md:mt-[-25px]">
          <div className="flex flex-col ">
            ...
            <p className=" nunito-sans font-[800] text-[32.14px] md:text-[40px] leading-[40px] md:leading-[50px]">Let us come together</p>
            <p className="nunito-sans font-[800] text-[32.14px] md:text-[40px] leading-[40px] md:leading-[30px]">
              to make a <span className=" italic font-[900] text-[#2282B4]">difference</span>
            </p>
