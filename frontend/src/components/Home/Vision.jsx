...
const Vision = () => {
  return (
    ...
    <div className=" h-auto w-full ">
      <div className="bg-[#FFF5E999]  h-auto md:px-22">
        <div className="max-w-[1480px] flex flex-wrap justify-center md:justify-between  items-center mx-auto">
        <div className="left-section max-w-[621px] min-h-[372px] p-5 md:mt-[-25px]">
          <div className="flex flex-col ">
            ...
            <p className="nunito-font font-extrabold text-[32.14px] md:text-[40px] leading-[30px]">
              to make a <span className=" italic text-[#2282B4]">difference</span>
            </p>
            <p className="nunito-font  text-[11px] md:text-[14.4px] leading-[25px]  mt-6 text-[#6E6E6E]">
            ...
            <p className="nunito-font text-[11px] md:text-[14.4px] leading-[25px]  mt-3 text-[#6E6E6E]">
              At the heart of our vision lies a world where every child has
              equal access to education, where women are empowered with
              opportunities, and where the youth is skilled and equipped to
              shape their future. We envision a society where education is a
        ...
        <div className=" right-section max-w-[621px] min-h-[350px] md:mt-6 md:min-h-[372px] p-x-5">
            <img src={Vision2} loading="lazy" alt="vision" className="w-[580px] h-[350px] md:h-[440px]" />
        </div>
        </div>
      </div>
    </div>
