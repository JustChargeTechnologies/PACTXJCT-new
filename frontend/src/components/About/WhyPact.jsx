    ...
    <div id='whypact' className='flex h-full w-[85%] md:w-[78%]'>
        <div className='min-h-[988px] nunito-sans'>
            ...
            <div className='flex flex-col mt-4 md:mt-4 gap-[32px]'>
                ...
                <div className='font-[400] leading-[24px] text-[#6E6E6E] italic xl:mt-[-50px]'>We facilitate think tanks throughout India, hosting conferences and seminars in collaboration with government and advocacy leaders to advance educational and social causes. Our events provide a platform for experts, policymakers, and citizens to come together and exchange ideas, insights, and best practices.</div>
