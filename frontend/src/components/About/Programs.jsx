        ...
        <div className="slider pt-[29px] md:pt-[20px] relative">
          ...
          {project.length > visibleSlides && (
            <>
              <button
                onClick={scrollLeft}
                className="absolute left-[-16px] md:left-[-30px] top-1/2 transform -translate-y-1/2 bg-green-500 w-[35px] h-[35px] md:h-[50px] md:w-[50px] flex items-center justify-center rounded-full shadow-lg"
              >
                <MdKeyboardArrowLeft className="text-white text-2xl" />
              </button>
              <button
                onClick={scrollRight}
                className="absolute right-[-20px] md:right-[-25px] top-1/2 transform -translate-y-1/2 bg-green-500 w-[35px] h-[35px] md:h-[50px] md:w-[50px] flex items-center justify-center rounded-full shadow-lg"
              >
